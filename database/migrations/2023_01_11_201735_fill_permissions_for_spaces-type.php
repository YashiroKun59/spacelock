...
class FillPermissionsForSpacesType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpacesType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.spaces-type',
            'admin.spaces-type.index',
            'admin.spaces-type.create',
            'admin.spaces-type.show',
            'admin.spaces-type.edit',
            'admin.spaces-type.delete',
            'admin.spaces-type.bulk-delete',
        ]);
