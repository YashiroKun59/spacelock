...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('config') }}"><i class="nav-icon la la-th-list"></i> Configs</a></li>
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('roles') }}"><i class="nav-icon la la-th-list"></i> Roles</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('sites') }}"><i class="nav-icon la la-th-list"></i> Sites</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('spaces') }}"><i class="nav-icon la la-th-list"></i> Spaces</a></li>
